...
local italic_undercurl = vim.g.nord_italic == false and "undercurl" or
                             "italic,undercurl"
...
local bold_underline = vim.g.nord_bold == false and "underline" or
                           "bold,underline"
local bold_italic;
...
theme.loadPlugins = function()
    ...
    local plugins = {
        ...
        AerialPropertyIcon = vim.g.nord_italic and
            {fg = nord.nord4_gui, style = italic} or {fg = nord.nord10_gui},
        AerialStringIcon = vim.g.nord_italic and
            {fg = nord.nord14_gui, style = italic} or {fg = nord.nord14_gui},
        ...
        -- Add here my custom configurations,
        TextYankPost_style = {fg = "#2d333b", bg = "#FFC49B", fmt = "bold"}
    }
    -- Options:
