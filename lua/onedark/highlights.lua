...
hl.common = {
    ...
    ToolbarLine = {fg = c.fg},
    Cursor = {bg = c.blue, fg= c.fg, fmt = "reverse"},
    vCursor = {fbg = c.purple_e, fg= c.fg, mt = "reverse"},
    iCursor = {bg = c.Charm_Pink, fg= c.fg, fmt = "reverse"},
    lCursor = {fmt = "reverse"},
    --CursorIM = {fmt = "reverse"},
    CursorIM = {bg = c.blue, fg= c.fg, fmt = "reverse"},
